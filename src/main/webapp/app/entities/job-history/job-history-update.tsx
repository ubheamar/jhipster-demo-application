  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterDemoApp.jobHistory.home.createOrEditLabel">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : jobHistoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                >
                  <option value="FRENCH">{translate('jhipsterDemoApp.Language.FRENCH')}</option>
                  <option value="ENGLISH">{translate('jhipsterDemoApp.Language.ENGLISH')}</option>
                  <option value="SPANISH">{translate('jhipsterDemoApp.Language.SPANISH')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
