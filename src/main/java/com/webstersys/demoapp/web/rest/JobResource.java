...
import com.webstersys.demoapp.domain.Job;
import com.webstersys.demoapp.repository.JobRepository;
...
/**
 * REST controller for managing {@link com.webstersys.demoapp.domain.Job}.
 */
@RestController
@RequestMapping("/api")
@Transactional
