package com.webstersys.demoapp.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.webstersys.demoapp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.webstersys.demoapp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
